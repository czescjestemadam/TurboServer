...
std::string HttpStatusCode::toString(const Val v)
{
	switch (v)
	{
		...
		case NONAUTHORATIVE_INFO: return "Non-Authorative Information";
		...
		case PROXY_AUTHENTICATION_REQUIRED: return "Proxu Authentication Required";
		case REQUEST_TIMEOUT: return "Request Timeout";
		case CONFLICT: return "Conflict";
		case GONE: return "Gone";
		case LENGHT_REQUIRED: return "Length Required";
		...
		case EXPECATAION_FAILED: return "Expectation Failed";
