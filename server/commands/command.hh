...
public:
	...
	virtual bool execute(CommandSender* sender, const std::string& alias, const std::vector<std::string>& args) = 0;
	virtual std::vector<std::string> suggest(CommandSender* sender, const std::string& alias, const std::vector<std::string>& args) = 0;
